...
def countDistinctPermutations(instr):
    ...
    print freqdict
    freqfact = 1
    for char, freq in freqdict.iteritems():
        freqfact *= factorial(freq)

    return factorial(len(instr))/freqfact



if __name__ == "__main__":
    print countDistinctPermutations('ybghjhbuytb')